...
function SidebarGroupLabel({
	...
	return (
		<Comp
			...
			className={cn(
				"flex h-auto pt-3 pb-1 text-[10px] shrink-0 items-center rounded-md px-2 text-muted-foreground/70 ring-sidebar-ring outline-hidden transition-[margin,opacity] duration-200 ease-linear group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0 focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
				className,
			)}
			{...props}
		/>
...
function SidebarGroupContent({
	...
	return (
		<div
			...
			className={cn("w-full text-xs mt-0", className)}
			{...props}
		/>
	);
}
